...
const generateData = () => {
  ...
  for (let i = 0; i < 10; i++) {
    data.push({
      ...
      explanation:
        'Personal anecdotes, sensory details, and nostalgic elements are highly typical of human writing.',
    })
    data.push({
      id: id++,
      type: 'text',
      ...
      explanation:
        'Overly encyclopedic, perfectly structured, generic facts often indicate AI generation.',
    })
  }
  ...
  for (let i = 0; i < 10; i++) {
    data.push({
      ...
      explanation:
        'Quirky comments, slightly non-idiomatic logic (<= items.length - 1) reflect human quirks.',
    })
    data.push({
      id: id++,
      type: 'code',
      ...
      explanation:
        'Perfect JSDoc comments, hyper-optimized functional approach, and sterile naming often point to AI.',
    })
  }
  ...
  for (let i = 0; i < 10; i++) {
    data.push({
      ...
      explanation:
        'Realistic lighting, natural imperfections, and sensible physics indicate a real photo.',
    })
    data.push({
      id: id++,
      type: 'image',
      ...
      explanation:
        'Odd background artifacts, overly smooth textures, and hyper-stylized lighting.',
    })
  }
  ...
  for (let i = 0; i < 10; i++) {
    data.push({
      ...
      explanation:
        'Visible brush strokes, emotional depth, and slight anatomical quirks.',
    })
    data.push({
      id: id++,
      type: 'artwork',
      ...
      explanation:
        'Excessively polished details, bizarre hand/finger structures, generic fantasy aesthetic.',
    })
  }
  ...
  for (let i = 0; i < 10; i++) {
    data.push({
      ...
      explanation:
        'Natural breathing sounds, subtle emotional cadence, varying pace.',
    })
    data.push({
      id: id++,
      type: 'voice',
      ...
      explanation:
        'Monotone delivery, lack of breathing pauses, overly consistent pronunciation.',
    })
  }

  const fileContent =
    "import { GameItem } from '../types';\n\nexport const mockData: GameItem[] = " +
