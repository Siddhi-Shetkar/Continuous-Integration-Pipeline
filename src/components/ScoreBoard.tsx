...
export const ScoreBoard: React.FC = () => {
  const { score, accuracy, currentStreak, bestStreak, currentIndex, items, timeRemaining, gameState } = useGame();
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
      ...
      />
      <StatCard 
        icon={<Timer className={timeRemaining < 10 ? "text-red-500 animate-pulse" : "text-green-500"} />}
